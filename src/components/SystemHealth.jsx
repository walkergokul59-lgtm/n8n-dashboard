...
export default function SystemHealth() {
    ...
    return (
        <div className="bg-[var(--c-raised)] rounded-xl p-6 shadow-lg border border-[var(--c-border-sub)] w-full flex flex-col relative overflow-hidden group">
            {/* Background Accent */}
            <div className="dark-only absolute bottom-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full blur-[40px] translate-y-1/2 translate-x-1/2 pointer-events-none transition-opacity duration-300 group-hover:bg-amber-500/10"></div>
            ...
            <div className="flex-1 flex flex-col justify-center space-y-6 relative z-10">
                ...
                <div>
                    ...
                    <div className="w-full bg-[var(--c-bg)] rounded-full h-2.5 border border-[var(--c-border-sub)] overflow-hidden">
                        <div
